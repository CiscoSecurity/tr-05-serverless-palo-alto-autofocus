...
[![Travis CI Build Status](https://travis-ci.com/CiscoSecurity/tr-05-serverless-palo-alto-autofocus.svg?branch=develop)](https://travis-ci.com/CiscoSecurity/tr-05-serverless-palo-alto-autofocus)

# Palo Alto AutoFocus Relay
...
```json
{
  "key": "<PALO_ALTO_AUTOFOCUS_API_KEY>"
}
```
